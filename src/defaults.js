...
export const makeDefaults = (type) =>
  ({
    ...
    videoGen: { uid: crypto.randomUUID(), prompt: "", model: "standard", resolution: "720p", duration: "auto", aspect: "auto", audio: true, loop: false, count: 1, videoUrls: [], loading: false, status: null, error: null },
